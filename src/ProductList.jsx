...
const handleAddToCart = (product) => {
    // Dispatch product to Redux store and update state
...
return (
    ...
    <h1 className="cart-icon" style={{ position: 'relative', display: 'inline-block' }}>
        ...
        {/* Add total number inside the cart */}
        {totalCartItems > 0 && (
            <span
                style={{
                    position: 'absolute',
                ...
                <div className="product-list">
                    {category.plants.map((plant, plantIndex) => (
                        <div className="product-card" key={plantIndex}>
                            ...
                            <div className="product-cost"><strong>Cost:</strong> {plant.cost}</div>
                            <button
